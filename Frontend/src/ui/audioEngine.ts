...
const SCENE_AUDIO: Record<number, SceneAudioConfig> = {
  1:  { droneFreq: 40,  droneGain: 0.12, organGain: 0.03, shimmerGain: 0.008, shimmerFreq: 523, pulseRate: 0.4, filterCutoff: 400  },
  2:  { droneFreq: 38,  droneGain: 0.14, organGain: 0.04, shimmerGain: 0.01,  shimmerFreq: 587, pulseRate: 0.3, filterCutoff: 500  },
  3:  { droneFreq: 36,  droneGain: 0.18, organGain: 0.05, shimmerGain: 0.015, shimmerFreq: 440, pulseRate: 0.6, filterCutoff: 600  },

  4:  { droneFreq: 35,  droneGain: 0.16, organGain: 0.05, shimmerGain: 0.012, shimmerFreq: 659, pulseRate: 0.5, filterCutoff: 700  },
  5:  { droneFreq: 32,  droneGain: 0.20, organGain: 0.06, shimmerGain: 0.018, shimmerFreq: 698, pulseRate: 0.4, filterCutoff: 800  },
  6:  { droneFreq: 33,  droneGain: 0.15, organGain: 0.07, shimmerGain: 0.02,  shimmerFreq: 784, pulseRate: 0.8, filterCutoff: 900  },
  7:  { droneFreq: 30,  droneGain: 0.22, organGain: 0.03, shimmerGain: 0.005, shimmerFreq: 392, pulseRate: 0.2, filterCutoff: 300  },

  8:  { droneFreq: 28,  droneGain: 0.24, organGain: 0.08, shimmerGain: 0.025, shimmerFreq: 880, pulseRate: 1.0, filterCutoff: 1000 },
  9:  { droneFreq: 27,  droneGain: 0.26, organGain: 0.10, shimmerGain: 0.030, shimmerFreq: 987, pulseRate: 1.2, filterCutoff: 1200 },
  10: { droneFreq: 25,  droneGain: 0.28, organGain: 0.08, shimmerGain: 0.020, shimmerFreq: 523, pulseRate: 0.5, filterCutoff: 600  },
  11: { droneFreq: 29,  droneGain: 0.20, organGain: 0.09, shimmerGain: 0.028, shimmerFreq: 1046,pulseRate: 1.1, filterCutoff: 1100 },
  16: { droneFreq: 33,  droneGain: 0.18, organGain: 0.07, shimmerGain: 0.022, shimmerFreq: 740, pulseRate: 0.7, filterCutoff: 850  },
  17: { droneFreq: 31,  droneGain: 0.20, organGain: 0.06, shimmerGain: 0.018, shimmerFreq: 660, pulseRate: 0.6, filterCutoff: 750  },
  18: { droneFreq: 28,  droneGain: 0.22, organGain: 0.09, shimmerGain: 0.025, shimmerFreq: 880, pulseRate: 0.9, filterCutoff: 950  },
  19: { droneFreq: 26,  droneGain: 0.25, organGain: 0.10, shimmerGain: 0.030, shimmerFreq: 1100,pulseRate: 1.3, filterCutoff: 1300 },
  20: { droneFreq: 22,  droneGain: 0.30, organGain: 0.12, shimmerGain: 0.035, shimmerFreq: 1200,pulseRate: 1.5, filterCutoff: 1500 },
  21: { droneFreq: 20,  droneGain: 0.32, organGain: 0.11, shimmerGain: 0.032, shimmerFreq: 1320,pulseRate: 1.4, filterCutoff: 1400 },

  12: { droneFreq: 20,  droneGain: 0.08, organGain: 0.01, shimmerGain: 0.002, shimmerFreq: 220, pulseRate: 0.1, filterCutoff: 200  }, // classical — near silence
  13: { droneFreq: 44,  droneGain: 0.18, organGain: 0.10, shimmerGain: 0.030, shimmerFreq: 1046,pulseRate: 0.6, filterCutoff: 1200 }, // extended framework — triumphant
  14: { droneFreq: 55,  droneGain: 0.10, organGain: 0.06, shimmerGain: 0.040, shimmerFreq: 1318,pulseRate: 0.3, filterCutoff: 2000 }, // unitarity — airy, open
  15: { droneFreq: 30,  droneGain: 0.20, organGain: 0.04, shimmerGain: 0.008, shimmerFreq: 440, pulseRate: 0.0, filterCutoff: 350  }, // remnant — frozen, still
  22: { droneFreq: 50,  droneGain: 0.14, organGain: 0.08, shimmerGain: 0.035, shimmerFreq: 1174,pulseRate: 0.4, filterCutoff: 1600 }, // boundary — infinite
  23: { droneFreq: 48,  droneGain: 0.16, organGain: 0.09, shimmerGain: 0.038, shimmerFreq: 1244,pulseRate: 0.5, filterCutoff: 1800 }, // new universe — wonder
};
