# Superposition — The Meissner Gap
...
Built on original research into the black hole Meissner effect in near-extremal Reissner–Nordström spacetimes — an ISEF selected project — where certain fields are expelled from the horizon as surface gravity approaches zero.

## Physics Concepts

- Event horizons and near-horizon geometry
- Surface gravity approaching zero (extremal limit)
